            ...
            <div class="d-flex">
                ...
                <div class="navbar-brand-box">
                    <a class="logo logo-dark">
                        <span class="logo-sm">
                            <img :src="require('@/assets/images/logo.svg')" alt="" height="22">
                        </span>
                        <span class="logo-lg">
                            <img :src="require('@/assets/images/logo-dark.png')" alt="" height="35">
                        </span>
                    </a>
                    ...
                    <a class="logo logo-light">
                        ...
                        <span class="logo-lg">
                            <img :src="require('@/assets/images/logo-light.png')" alt="" height="35">
                            <!-- <img :src="require('@/assets/images/logo-light-high.png')" alt="" height="35"> -->
                        </span>
                    </a>
                </div>
            ...
            <div class="d-flex">
                ...
                <div class="dropdown d-none d-md-block ml-2">
                    <button type="button" class="btn header-item waves-effect"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="mr-2" :src="require('@/assets/images/flags/us_flag.jpg')" alt="Header Language" height="16"> English <span class="mdi mdi-chevron-down"></span>
                    </button>
                    <div class="dropdown-menu dropdown-menu-right">
                        <!-- item-->
                        <a href="javascript:void(0);" class="dropdown-item notify-item">
                            <img :src="require('@/assets/images/flags/cn_flag.jpg')" alt="user-image" class="mr-1" height="12"> <span class="align-middle"> Chinese </span>
                        </a>
                    </div>
                </div>
                ...
                <div class="dropdown d-inline-block">
                    <button type="button" class="btn header-item waves-effect" id="page-header-user-dropdown"
                        data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img class="rounded-circle header-profile-user" :src="require('@/assets/images/users/user-4.jpg')"
                            alt="Header Avatar">
                    </button>
                    <div class="dropdown-menu dropdown-menu-right">
                        <!-- item-->
