...
def ini_setting_var():
    ...
    if get_setting(items=['common', 'dark_mod'], default='off') == 'on':
        ...
        elif palette == 'Light Blue Aroma':
            COLOR_BACK = '#a1afc7';COLOR_FRONT = 'black';COLOR_SUB = '#a1afc7';COLOR_MB_FRONT = 'black'
            COLOR_F1_BACK = '#a1afc7';COLOR_F2_BACK = "#a1afc3";COLOR_F2_FRONT = "black"
        elif palette == 'Stock':
...
def information_control_add(first=True): # 信息添加 b1_2 按钮
    ...
    def infor_control_add_infor_next(event=None):
    ...
    def infor_control_add_pack():
        ...
        e1_2_3.bind("<Return>",infor_control_add_infor_next)  
        e1_2_3.pack(fill = 'x')
...
def database_control_add():# 数据库增加 b3_1 按钮_按Excel导入
    ...
    def database_add_frame_setting():
        ...
        # 添加按钮
        global b3_1_2
        b3_1_2 = CpButton(window, text=["Creat","创建"], width=20, height=3,command=lambda:add_database())
        b3_1_2.pack()
        # 数据库名称
        global e3_1_1
        e3_1_1 = tk.Entry(window,bg = COLOR_F2_BACK,fg = COLOR_FRONT)
        e3_1_1.pack(fill = 'x')
        # 
    def nameValid(name):
        ''' 名称合法性
...
def RefreshListbox(Listbox,Scrollbar,allData=True):
    ''' 进行使用模板内容填充Listbox
    '''
...
def CpLabel(father, text, width=20, height=1,justify="center",anchor="center"):
    ...
    return tk.Label(father, text=text, width=width, height=height,justify=justify, bg = COLOR_SUB,fg = COLOR_FRONT)
